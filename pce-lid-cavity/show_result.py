...
plt.figure()
plt.plot(y_line, pce_u_mean_along_line, label='PCE', linewidth=1)
plt.scatter(y_line[::3], mc_u_mean_along_line[::3], label='Monte Carlo', marker='+', s=50)
plt.xlabel('y')
plt.ylabel('E[u]')
...
plt.figure()
plt.plot(y_line, pce_u_var_along_line, label='PCE', linewidth=1, color='red')
plt.scatter(y_line[::3], mc_u_var_along_line[::3], label='Monte Carlo', marker='+', c='r', s=50)
plt.xlabel('y')
plt.ylabel('Var[u]')
...
plt.figure()
plt.plot(y_line, pce_v_mean_along_line, label='PCE', linewidth=1, color='green')
plt.scatter(y_line[::3], mc_v_mean_along_line[::3], label='Monte Carlo', marker='+', c='g', s=50)
plt.xlabel('y')
plt.ylabel('E[v]')
...
plt.figure()
plt.plot(y_line, pce_v_var_along_line, label='PCE', linewidth=1, color='black')
plt.scatter(y_line[::3], mc_v_var_along_line[::3], label='Monte Carlo', marker='+', c='k', s=50)
plt.xlabel('y')
plt.ylabel('Var[v]')
